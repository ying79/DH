...
Target kanji:
Please start by listing **all common readings** for this kanji in the format
「◯◯（かな / romaji）」.
If there is more than one reading, list **all of them** in one line, for example: 「◯◯（かな1 / romaji1　、　「◯◯（かな2 / romaji2）」
Target kanji : 「{q}」
